...
public class TwitterBot {
     ...
     */
    static final String PATH_TO_TWEETS = "files/trump.csv";
    /** Column in the PATH_TO_TWEETS CSV file to read tweets from */
    static final int TWEET_COLUMN = 3;
    ...
    public static void main(String[] args) {
        ...
        List<String> tweets = t.generateTweets(10, 300); // 280 chars in a tweet
